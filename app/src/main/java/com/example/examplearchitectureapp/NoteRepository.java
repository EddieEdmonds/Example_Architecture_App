package com.example.examplearchitectureapp;
...
public class NoteRepository {
    ...
    //The below 4 methods are basically the API that the repository is exposing to the outside.
    //View model only needs to call insert, update, delete, deleteAllNotes, or getAllNotes on this repository.
    //View model doesn't have to care what these methods actually do.
